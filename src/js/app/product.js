...
import { countCartItem, crateCartItem, updateCartItemCount, updateCartTotal } from "./cart";
...
export const renderStar =(rate) => {
    ...
    for(let i = 1; i <= 5; i++){
        stars += ` <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-4 h-4 ${i<= Math.round(rate) ? 'fill-gray-700' : 'fill-gray-400'}">
